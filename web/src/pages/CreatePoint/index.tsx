...
const CreatePoint = () => {
    ...
    /**
     * Posição posição atual do usuário
     */
    ...
    useEffect(() => {
        ...
        axios
            .get<IBGECiyResponse[]>(`https://servicodados.ibge.gov.br/api/v1/localidades/estados/${selectedUf}/municipios`)
            .then( response => {
    ...
    function handleSelectItem(id:number){
        ...
        /**
         * Verificar se o item já esta marcado
         */
        if(alreadySelected >= 0){
            // Pegando todos diferentes do que eu quero remover
            const filteredItens = selectedItems.filter(item => item !== id);
            setSelectedSelectedItems( filteredItens );

        } else {
            setSelectedSelectedItems([ ...selectedItems, id ]);
        }
    };
